 ...
 */
class getWeatherForecastRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WeatherForecastRepository' shared autowired service.
     *
     * @return \App\Repository\WeatherForecastRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WeatherForecastRepository.php';

        return $container->privates['App\\Repository\\WeatherForecastRepository'] = new \App\Repository\WeatherForecastRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
